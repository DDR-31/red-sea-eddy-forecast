...
# iterasi sekali untuk mendapatkan semua prediksi & data asli
all_actual_val = []
all_pred_val = []
all_squared_errors = []
all_actual_slices = []
...
ax4.set_title('d) Spatial Root Mean Square Error')
ax4.invert_yaxis()
...
ax6.set_title(f"Hovmöller: Predicted SLA (m)\n(@ Lat {lat_coord[LAT_SLICE_INDEX]:.2f}°N)")
...
# --- Finalisasi ---
fig.suptitle("U-Net ConvLSTM Model Performance Summary: Red Sea SLA Prediction)", fontsize=20, y=0.98)
